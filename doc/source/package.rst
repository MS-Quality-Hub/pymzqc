...
Please note that most member attributes of the MZQCFile submodule classes and many functional elements do not conform to `PEP-8 <https://peps.python.org/pep-0008/>`_ snake_case.
