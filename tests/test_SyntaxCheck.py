...
def test_SyntaxCheck_synth():
    ...
    infi = mzqc_lib.InputFile(name="file.raw", location="file:///dev/null",
                              ...
                              file_properties=[mzqc_lib.CvParameter(accession="MS:1000747",
    ...
    meta = mzqc_lib.MetaDataParameters(input_files=[infi], analysis_software=[anso], label="test_label")
    ...
    mzqc = mzqc_lib.MzQcFile(version="1.0.0", run_qualities=[rq], set_qualities=[sq], controlled_vocabularies=[cv, cv2])
